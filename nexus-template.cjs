...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Veterans Court Coordination System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Veteran Participant";
process.env.TABLE_NAME = process.env.TABLE_NAME || "veteran_participant_records";
'use strict';
